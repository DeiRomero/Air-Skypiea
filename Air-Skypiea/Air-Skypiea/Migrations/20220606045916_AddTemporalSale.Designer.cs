...
namespace Air_Skypiea.Migrations
{
    ...
    [Migration("20220606045916_AddTemporalSale")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Air_Skypiea.Data.Entities.Flight", b =>
                {
                    ...
                    b.HasIndex("SourceId", "TargetId")
                        .IsUnique()
                        .HasFilter("[SourceId] IS NOT NULL AND [TargetId] IS NOT NULL");
            ...
            modelBuilder.Entity("Air_Skypiea.Data.Entities.TemporalFightSale", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Air_Skypiea.Data.Entities.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
