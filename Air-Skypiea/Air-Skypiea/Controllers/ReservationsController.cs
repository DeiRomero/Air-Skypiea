    ...
    public class ReservationsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.reservations != null ? 
                          ...
                          Problem("Entity set 'DataContext.reservations'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Code,flightStatus,Remark")] Reservation reservation)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Code,flightStatus,Remark")] Reservation reservation)
        {
