        ...
        public class FlightController : Controller
        {
            ...
            public async Task<IActionResult> Create(CreateFlightViewModel model)
            {
                if (ModelState.IsValid)
                {
                    ...
                    {
                        imageId = await _blobHelper.UploadBlobAsync(model.ImageFile, "Flight");
                    }
            ...
            public async Task<IActionResult> AddImage(AddFlightImageViewModel model)
            {
                if (ModelState.IsValid)
                {
                    Guid imageId = await _blobHelper.UploadBlobAsync(model.ImageFile, "Flight");
            ...
            public async Task<IActionResult> DeleteImage(int? id)
            {
                ...
                await _blobHelper.DeleteBlobAsync(FlightImage.ImageId, "Flight");
